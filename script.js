...
let printMovies = () => {
  ...
  console.log(" ");
  console.log("Total numbers of movies in array: " + (allMovies.length));
}
...
let highRatings = (rating) => {
  console.log("Printing movies with higher ratings than " + rating);
  let counter = 0;
  for (let i = 0; i < allMovies.length; i++) {
...
let changeWatched = (title) => {
  console.log("Changing the status of movie");
  for (let i = 0; i < allMovies.length; i++) {
